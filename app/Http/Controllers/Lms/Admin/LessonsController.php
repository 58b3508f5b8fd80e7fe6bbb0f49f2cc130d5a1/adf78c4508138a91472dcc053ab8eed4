...
class LessonsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('lms.admin.lessons.create', compact('courses'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.lessons.edit', compact('lesson', 'courses'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.lessons.show', compact('lesson', 'tests'));
    }
