...
class QuestionsOptionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lms.admin.questions_options.index', compact('questions_options'));
    }
    ...
    public function create()
    {
        ...
        return view('lms.admin.questions_options.create', compact('questions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.questions_options.edit', compact('questions_option', 'questions'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.questions_options.show', compact('questions_option'));
    }
