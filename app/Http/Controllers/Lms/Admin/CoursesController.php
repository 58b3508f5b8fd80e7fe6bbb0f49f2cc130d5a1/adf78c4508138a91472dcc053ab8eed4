...
class CoursesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lms.admin.courses.index', compact('courses'));
    }
    ...
    public function create()
    {
        ...
        return view('lms.admin.courses.create', compact('teachers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.courses.edit', compact('course', 'teachers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.courses.show', compact('course', 'lessons', 'tests'));
    }
