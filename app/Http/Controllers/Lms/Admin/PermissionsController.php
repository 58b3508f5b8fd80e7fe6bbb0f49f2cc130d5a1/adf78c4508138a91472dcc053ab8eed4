...
class PermissionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lms.admin.permissions.index', compact('permissions'));
    }
    ...
    public function create()
    {
        ...
        return view('lms.admin.permissions.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.permissions.edit', compact('permission'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.permissions.show', compact('permission', 'roles'));
    }
