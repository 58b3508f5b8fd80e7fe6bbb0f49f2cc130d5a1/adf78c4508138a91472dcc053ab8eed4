...
class QuestionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lms.admin.questions.index', compact('questions'));
    }
    ...
    public function create()
    {
        ...
        return view('lms.admin.questions.create', compact('tests'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.questions.edit', compact('question', 'tests'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.questions.show', compact('question', 'questions_options', 'tests'));
    }
