...
class TestsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('lms.admin.tests.create', compact('courses', 'lessons'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.tests.edit', compact('test', 'courses', 'lessons'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.tests.show', compact('test'));
    }
