...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('lms.admin.users.create', compact('roles'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.admin.users.edit', compact('user', 'roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lms.admin.users.show', compact('user', 'courses'));
    }
