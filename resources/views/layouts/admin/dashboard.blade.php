...
<i class="fa fa-search"></i>
    ...
    <nav id="sidebar">
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 316px;"><div id="sidebar-scroll" style="overflow: hidden; width: auto; height: 316px;">
...
<span class="text-dual-primary-dark">c</span><span class="text-primary">b</span>
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            ...
                            <ul class="list-inline mt-10">
                                <li class="list-inline-item">
                                    <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="be_pages_generic_profile.html">{{title_case(Auth::user()->first_name)}}</a>
                                </li>
                                <li class="list-inline-item">
            ...
            </div><div class="slimScrollBar" style="background: rgb(205, 205, 205) none repeat scroll 0% 0%; width: 4px; position: absolute; top: 0px; opacity: 0.9; display: none; border-radius: 7px; z-index: 99; right: 0px; height: 96.4792px;"></div><div class="slimScrollRail" style="width: 4px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; opacity: 1; z-index: 90; right: 0px;"></div></div>
    </nav>
