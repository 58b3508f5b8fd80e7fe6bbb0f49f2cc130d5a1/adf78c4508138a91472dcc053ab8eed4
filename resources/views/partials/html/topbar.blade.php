<header id="page-header">
    <div class="content-header">
        ...
        <div class="content-header-section">
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu dropdown-menu-right min-width-150"
                    ...
                    <a class="dropdown-item" href="{{url('/')}}">
                        <i class="si si-home mr-5"></i> Homepage
                    </a>
                    <a class="dropdown-item d-flex align-items-center justify-content-between"
                       href="{{url('/backend')}}">
                        <span><i class="si si-envelope-open mr-5"></i> Admin Panel</span>
                    </a>
                    <a class="dropdown-item" href="{{url('/admin')}}">
                        <i class="si si-note mr-5"></i> Control Panel
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{url('/learning/admin')}}" data-toggle="layout"
                       data-action="side_overlay_toggle">
                        <i class="si si-key"></i> LMS
                    </a>
                    <div class="dropdown-divider"></div>
            ...
            <button type="button" class="btn btn-circle btn-dual-secondary" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
