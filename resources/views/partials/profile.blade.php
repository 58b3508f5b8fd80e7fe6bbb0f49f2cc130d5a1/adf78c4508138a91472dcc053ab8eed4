                        ...
                        <div class="careerfy-column-9">
                            ...
                            <div class="careerfy-typo-wrap">
                                <div class="careerfy-employer-box-section">
                                    <div class="col-sm-4">
                                        <a href="#" class="img-thumbnail img-rounded"><img src="{{Storage::url(Auth::user()->avatar_location)}}" class="user-avatar" alt=""></a>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="js"
                                            ...
                                            <form method="post"
                                                ...
                                                <div class="box__input text-center">
                                                    ...
                                                    <input type="file" name="avatar_location" id="file" class="box__file"
                                                           accept=".png,.jpg,.jpeg"
                                                           data-multiple-caption="{count} files selected"/>
                                                    <label for="file"><strong>Select your CV</strong><span
                                                                class="box__dragndrop"> or drag it here</span>.</label>
                                                    <p class="notice">Only .pdf file formats are accepted..</p>
