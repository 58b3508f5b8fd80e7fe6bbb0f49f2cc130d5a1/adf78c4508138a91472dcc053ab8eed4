                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="careerfy-column-9" id="results">
                            </di class="block-content">
                            <form action="{{url('/backend/jobs/add')}}" method="post" id="job-form">
                                {{csrf_field()}}
                                <ul class="careerfy-row careerfy-employer-profile-form">
                                    <li class="careerfy-column-12">
                                        <label for="title">Title</label>
                                        <input id="title" name="title" type="text" placeholder="Enter the Job Title">
                                    </li>
                                    ...
                                    <li class="careerfy-column-6">
                                        ...
                                        <div class="careerfy-profile-select"><select id="lga">
                                    ...
                                    <li class="careerfy-column-6">
                                        ...
                                        <select name="qualification[]" id="qualifiction" multiple="multiple"
                                                class="form-control">
