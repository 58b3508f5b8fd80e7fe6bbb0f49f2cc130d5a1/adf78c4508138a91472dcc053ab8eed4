...
class ReflectionConstantTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $refl = new ReflectionConstant_('Psy\\Online_test\\Reflection\\SOME_CONSTANT');

        $this->assertFalse($refl->getDocComment());
        $this->assertEquals('Psy\\Online_test\\Reflection\\SOME_CONSTANT', $refl->getName());
        $this->assertEquals('Psy\\Online_test\\Reflection', $refl->getNamespaceName());
        $this->assertEquals('yep', $refl->getValue());
        $this->assertTrue($refl->inNamespace());
        $this->assertEquals('Psy\\Online_test\\Reflection\\SOME_CONSTANT', (string) $refl);
    ...
    public function magicConstants()
    {
        return [
            ...
            ['PHP_VERSION', false],
            ['PHP_EOL', false],
            ['Psy\\Online_test\\Reflection\\SOME_CONSTANT', false],
    ...
    {
        $ret = ReflectionConstant_::export('Psy\\Online_test\\Reflection\\SOME_CONSTANT', true);
        $this->assertEquals($ret, 'Constant [ string Psy\\Online_test\\Reflection\\SOME_CONSTANT ] { yep }');
    }

    public function testExportOutput()
    {
        $this->expectOutputString("Constant [ string Psy\\Online_test\\Reflection\\SOME_CONSTANT ] { yep }\n");
        ReflectionConstant_::export('Psy\\Online_test\\Reflection\\SOME_CONSTANT', false);
    }
