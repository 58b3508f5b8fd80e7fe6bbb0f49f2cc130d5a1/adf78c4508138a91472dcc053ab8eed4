...
class CronExpressionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function scheduleProvider()
    {
        return array(
            ...
            // Online_test lists of values and ranges (Abhoryo)
            ...
            // Online_test increments of ranges
            ...
            //array('0 0 * * 0,2-6', strtotime('2011-06-20 23:09:00'), '2011-06-21 00:00:00', false),
            // Online_test Day of the Week and the Day of the Month (issue #1)
            ...
            // Online_test the W day of the week modifier for day of the month field
            ...
            // Online_test the hash symbol for the nth weekday of a given month
